      ...
      <div class="container h-100">
        <div class="row d-flex justify-content-center align-items-center h-100">
          <div class="col col-xl-8">
            <div class="card" style="border-radius: 30px; overflow: hidden; box-shadow: 5px 5px 10px #16261c;">
              <div class="row g-0">
                <div class="col-md-6 col-lg-4 d-flex justify-content-center align-items-center"
                  style="box-shadow: 5px 0 10px -5px #1e4e2e;">
                  <div class="logo-circle">
                    <img src="./assets/brand/nwl-logo.png" />
                  </div>
                </div>
                  ...
                  <div class="d-flex flex-column justify-content-between w-100">
                    <div class="card-body p-4 p-lg-5 text-black">
                      <form>
                        ...
                        <div class="pt-1 mb-4">
                          <button data-mdb-button-init data-mdb-ripple-init class="login-btn" type="button"
                            onclick="login()">Login</button>
                        </div>

                        <p><a data-bs-toggle="modal" data-bs-target="#forgetpasswordmodal" href="#!"
                            style="color: #1A4D2E;">ลืมรหัสผ่าน?</a></p>
                        <p style="color: #1A4D2E;">ถ้ายังไม่มีชื่อผู้ใช้งาน <a data-bs-toggle="modal"
                            data-bs-target="#registermodal" href="#"
                            style="color: #08CB00;">คลิกที่นี่เพื่อสมัครชื่อผู้ใช้งาน</a></p>
                      </form>
                      <!-- <div class="d-flex justify-content-end">
                        <div class="py-3 px-5">
                          <img src="./assets/brand/nwl-logo.png" width=50>
                          <span class="fw-medium mb-0 text-white"
                            style=" font-size: clamp(12px, 2.5vw, 14px);  letter-spacing: 1px; color: #dfdfdf;">NetWorklink.Co.Ltd,</span>
                        </div>
                      </div> -->
                    </div>
                    <div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="card text-center" style="width: 100%;">
          <div class="text-uppercase card-header h5 text-white  d-flex p-3"
          ...
          <div class="card-body px-5 py-5" style="padding-top: 1rem!important;">
            <div data-mdb-input-init class="form-outline">
              <div class="d-flex justify-content-center align-items-center">
                <div>
                  <img class="icon-secure" src="./assets/icon/security_icon.png" />
                </div>
              </div>
              <form id="forgetpassForm">
                ...
                <div class="inputGroups">
                  <input type="email" required autocomplete="off" class="form-control-lg" id="forgetemail"
      ...
      <div class="modal-content">
        <div class="card text-center" style="width: 100%;">
          <div class="card-header h5 text-white d-flex p-3"
            ...
            <button type="button" id="btn-close-register" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
              style="font-size: 14px;"></button>
          </div>
          <div class="card-body px-5 py-5" style="padding-top: 1rem!important;">
            <div class="d-flex justify-content-center align-items-center">
              <div>
                <img class="icon-regis" src="./assets/icon/regis_icon.png" />
              </div>
            </div>
            <form id="registerForm">
              ...
              <div class="inputGroups">
                <input type="email" required autocomplete="off" class="form-control-lg" id="emailregis" placeholder=" "
...
<script>
  ...
  inputs.forEach(input => {
    ...
    input.addEventListener('mouseover', function () {
      this.title = 'กรุณากรอกข้อมูลในช่องนี้';
    });
