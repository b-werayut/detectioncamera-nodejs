        ...
        <div class="scc-navbar-inner">
            ...
            <a class="scc-brand" href="#!">
                ...
                <div class="scc-brand-text">
                    <span class="scc-brand-name d-none d-sm-block">NetWorklink</span>
                        ...
                        <div class="scc-user-dropdown" id="sccUserDropdown">
                            <button class="scc-user-trigger" type="button" aria-expanded="false">
                                ...
                                <span class="scc-user-meta d-none d-md-flex">
                                    <span class="scc-user-name"><?= htmlspecialchars($user); ?></span>
                                    <?php if (!empty($role)): ?>
                                        <span class="scc-user-role"><?= htmlspecialchars($role); ?></span>
                                    <?php endif; ?>
                                </span>
                            ...
                            <div class="scc-user-panel">
                                <div class="scc-user-panel-header">
                                    ...
                                    <div class="scc-user-panel-name"><?= htmlspecialchars($user); ?></div>
                                    <?php if (!empty($role)): ?>
...
@media (min-width: 1200px) {
    .scc-brand-name { font-size: 1.1rem; }
    .scc-nav-link { padding: 0.5rem 1.15rem; }
}
...
@media (max-width: 576px) {
    .scc-brand-logo img { width: 36px; }
    .scc-brand-name { font-size: 0.9rem; }
    .scc-nav-link { padding: 0.65rem 0.85rem; font-size: 0.88rem; }
    .scc-user-avatar { width: 30px; height: 30px; min-width: 30px; }
}
</style>
