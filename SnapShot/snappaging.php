    ...
    <header class="py-2 ">
        <div class="container px-lg-5 ">
            <div class="p-4 p-lg-5 bg-light rounded-3 text-center bg-dark">
                <div class="">
                    <h1 class="display-5 fw-bold text-white text-uppercase" style="letter-spacing: 10px">Snapshot</h1>
                </div>
                    ...
                    <form id="dateform" class="col-md-12 position-relative" method="GET" action="">
                        ...
                        <div class="py-1 d-inline-block">
                            <input type="text" disable class="form-control form-control-sm" id="dateinput"
                                name="dateinput" value="" placeholder="Choose date"><i class="fa fa-calendar"
                                aria-hidden="true"></i>
                        </div>
                    ...
                    <div class="row py-2 content1" style="background-color: white; ">
                        <ul>
                            <li style="background-color: white;">
                                ...
                                <hr>
                                <?php
                            $snap = "../snapfolder/{$dateparam}/{$snapparam}/img/*";
                            $snapshots = glob($snap); ?>
                ...
                <div class="row py-2 content1" style="background-color: white; ">
                    <ul>
                        ...
                        <li style="background-color: white;">
                            ...
                            <hr>
                            <?php
                              $snap = "../snapfolder/{$dateparam}/{$pathsnapfm}/img/*";
                              $snapshots = glob($snap); ?>
                            <div class=" row p-0 gap-0">
                                <?php
                              if(empty($snapshots)){
